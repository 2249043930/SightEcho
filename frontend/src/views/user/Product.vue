...
const { loading, result, submit } = useRecognition('product');
...
<template>
  <div class="product-page" :class="{ mobile: isMobile }">
    <header class="page-header">
      <h1 class="page-title">商品识别</h1>
      <p class="page-desc">对准商品包装，识别品牌、名称与规格</p>
    </header>
...
.product-page { display: flex; flex-direction: column; gap: 16px; height: 100%; }
