...
const { loading, result, submit } = useRecognition('currency');
...
<template>
  <div class="currency-page" :class="{ mobile: isMobile }">
    <header class="page-header">
      <h1 class="page-title">货币识别</h1>
      <p class="page-desc">对准纸币，将读出面额与真伪提示</p>
    </header>
...
.currency-page { display: flex; flex-direction: column; gap: 16px; height: 100%; }
